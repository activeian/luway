"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{IO:function(){return query},PL:function(){return getDocs},ad:function(){return getFirestore},ar:function(){return where},b9:function(){return limit},hJ:function(){return collection}});var n,i,s,a,o=r(3991),l=r(5538),u=r(6914),c=r(8745),_=r(3172),h=r(4203);r(2601);var d=r(263).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let P=new SortedMap(DocumentKey.comparator),A=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=A;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=A;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}new SortedMap(DocumentKey.comparator);let y=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=y;for(let r of e)t=t.add(r);return t}let R=new SortedSet(__PRIVATE_primitiveComparator);function __PRIVATE_targetIdSet(){return R}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
